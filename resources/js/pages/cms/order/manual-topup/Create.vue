...
import { store } from '@/actions/App/Http/Controllers/Cms/Order/ManualTopupOrderController';
...
<template>
    <Modal v-slot="{ close }">
        <div class="p-6">
            <h2 class="text-lg font-medium">Create Manual Topup Order</h2>

            <p class="mt-1 text-sm text-muted-foreground">
                Create a new manual topup order.
            </p>
