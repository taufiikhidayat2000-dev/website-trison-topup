...
import { sync } from '@/actions/App/Http/Controllers/Cms/PPOB/ImportLapakGamingController';
...
const title = 'Import LapakGaming';
const description = 'Select products to import from LapakGaming.';
    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="flex items-center justify-between">
                ...
                <Button
                    :disabled="form.processing || !props.enabled"
                    @click="submit"
                >
            ...
            <div
                v-if="!props.enabled"
                class="rounded-lg border border-yellow-500/50 bg-yellow-500/10 p-4 text-sm text-yellow-600"
            >
                LapakGaming belum aktif. Lengkapi
                <code>LAPAKGAMING_SECRET_KEY</code> dan set
                <code>LAPAKGAMING_ENABLED=true</code> di <code>.env</code>,
                lalu pastikan IP server sudah di-whitelist oleh LapakGaming
                sebelum menyinkronkan produk.
            </div>
