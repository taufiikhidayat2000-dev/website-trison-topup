...
import { PPOBCategoryDataItem, PPOBProductCategoryDataItem } from '@/types/cms/ppob';
        ...
        <div class="p-6">
            ...
            >
                ...
                <div class="grid gap-2">
                    ...
                    <Select name="p_p_o_b_product_category_id">
                        <SelectTrigger
                ...
                <div class="grid gap-2">
                    ...
                    <InputDescription>
                        Upload the PPOB product image (Max 5MB). Recommended size: 500x500 px (square).
                    </InputDescription>
                    <ImageUploadPreview
                        input-id="image"
                        input-name="image"
                        label=""
                        description="Upload your PPOB product image here. Recommended size: 500x500 px (square)."
                        accept="image/*"
                        :max-size="5"
